...
set_false_path -from [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[0]}]

set_false_path  -from  [get_clocks {mypll2|altpll_component|auto_generated|pll1|clk[0]}]  -to  [get_clocks {mypll2|altpll_component|auto_generated|pll1|clk[1]}]
set_false_path  -from  [get_clocks {mypll2|altpll_component|auto_generated|pll1|clk[1]}]  -to  [get_clocks {mypll2|altpll_component|auto_generated|pll1|clk[0]}]
...
set_false_path  -from  [get_clocks {mypll2|altpll_component|auto_generated|pll1|clk[0]}]  -to  [get_clocks {mypll3|altpll_component|auto_generated|pll1|clk[0]}]
...
set_false_path  -from  [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[0]}] -to [get_clocks {mypll2|altpll_component|auto_generated|pll1|clk[0]}]  
...
set_false_path  -from  [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[0]}] -to [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[1]}]  
set_false_path  -from  [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[1]}] -to [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[0]}]  
set_false_path -from [get_clocks {clk50m}] -to [get_clocks {mypll3|altpll_component|auto_generated|pll1|clk[0]}]
set_false_path -from [get_clocks {mypll3|altpll_component|auto_generated|pll1|clk[0]}] -to [get_clocks {clk50m}]
set_false_path -from [get_clocks {clk50m}] -to [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[1]}]
set_false_path -from [get_clocks {mypll|altpll_component|auto_generated|pll1|clk[1]}] -to [get_clocks {clk50m}]
